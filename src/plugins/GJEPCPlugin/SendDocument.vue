  ...
  <div class="creatFile">
    ...
    >
      <el-form :model="fileForm" ref="fileForm">
        <el-form-item label="函数编码" prop="detail">
          <el-col :span="6">
          ...
          <el-col :span="6">
            ...
            <div class="fileLine">函数流水号</div>
          </el-col>
        </el-form-item>
        <el-form-item label="函数主题" prop="theme">
        ...
        <el-form-item label="函数附件" class="uploadItem" prop="file">
...
export default {
  ...
  // computed: {
  //   ...mapGetters("doc", ["List"]),
  //   ...mapGetters("project", ["ProjectKeyWord"])
  // },
  data() {
    return {
      autoUpload: false,
      ...
      this.$refs[formName].validate(valid => {
        if (valid) {
          ...
          let attrJSON = [
            ...
            { name: "ReplyDate", value: this.fileForm.date },
          ...
          docAPI.sendDocument(ProjectKeyWord, docAttrJson).then(res => {
            if (res.success) {
              this.$message({
                message: "添加成功",
                type: "success"
