      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="120px" class="projectForm">
        <el-row>
          <el-row>
            ...
            <el-col :span="8">
              <el-form-item label="总投资" prop="tatolInvest">
                <el-input v-model="form.tatolInvest"></el-input>
              </el-form-item>
          ...
          <el-col :span="16">
            <el-form-item label="所在地区">
              <v-distpicker :province="user.xtrysf" :city="user.xtrycs" :area="user.xtryar"
          ...
          <el-col :span="8">
            <el-form-item label="项目公司名称" prop="procomName">
              <el-input v-model="form.procomName"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="所属区域中心" prop="regCen">
              <el-input v-model="form.regCen"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="投资模式" prop="invModel">
              <el-input v-model="form.invModel"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="业务类别" class="businessType" prop="typeb">
              <el-select v-model="form.typeb" @change="businessTypeChange">
                <el-option
          ...
          <el-col :span="8">
            <el-form-item label="开工时间" prop="comTime">
              <!-- <el-input v-model="form.comTime"></el-input> -->
              <el-date-picker type="date" v-model="form.startWorkDate" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="总规模" prop="oveScope">
              <el-input v-model="form.oveScope"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="项目角色" prop="projectRole">
              <el-input v-model="form.projectRole"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="16">
          ...
          <el-col :span="16">
            <el-form-item label="建设规模" prop="conScale">
              <el-input v-model="form.conScale"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="总装机容量" prop="totalCap">
              <el-input v-model="form.totalCap"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="注册时间" prop="registrationTime">
              <!-- <el-input v-model="form.registrationTime"></el-input> -->
              <el-date-picker type="date" v-model="form.regDate" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="投运时间" prop="commissTime">
              <!-- <el-input v-model="form.commissTime"></el-input> -->
              <el-date-picker type="date" v-model="form.commissDate" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
          <!-- <el-col :span="12">
...
// import AddrSelector from './AddrSelector' // 项目立项
...
export default {
  ...
  data() {
    return {
      ...
      BusinessType: [
        { value: "在建项目", label: "在建项目" },
        { value: "竣工项目", label: "竣工项目" },
        { value: "策划项目", label: "策划项目" },
        { value: "审批项目", label: "审批项目" }
      ],
      projectType2Options: [
        ...
        if (valid) {
          let projectAttrJson = [
            ...
            // { name: "designScope", value: this.form.gist }
             { name: "projectName", value: this.form.projectName },
             { name: "projectNum", value: this.form.projectNum },
             { name: "tatolInvest", value: this.form.tatolInvest },
             { name: "projectType", value:this.form.projectType },
             { name: "procomName", value: this.form.procomName },
             { name: "regCen", value: this.form.regCen },
             { name: "proStatus", value: this.form.proStatus },
             { name: "invModel", value: this.form.invModel },
             { name: "typeb", value: this.form.typeb },
             { name: "comTime", value: this.form.comTime },
             { name: "oveScope", value: this.form.oveScope },
             { name: "areaCovered", value: this.form.areaCovered },
             { name: "floorage", value: this.form.floorage },
             { name: "projectRole", value: this.form.projectRole },
             { name: "projectAddress", value: this.form.projectAddress },
             { name: "conScale", value: this.form.conScale },
             { name: "totalCap", value: this.form.totalCap },
             { name: "registrationTime", value: this.form.registrationTime },
             { name: "commissTime", value: this.form.commissTime },
          ];
